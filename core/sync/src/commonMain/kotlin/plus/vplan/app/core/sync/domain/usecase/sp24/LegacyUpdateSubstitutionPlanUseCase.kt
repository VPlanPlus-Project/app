...
private val LOGGER = Logger.withTag("LegacyUpdateSubstitutionPlanUseCase")


@Deprecated("Use new usecase")
class LegacyUpdateSubstitutionPlanUseCase(
...
//                        date = date,
//                        oldLessons = substitutionPlanRepository.getForProfile(profile, date).first()
//                    )
//                }
//            }
//
