...
import plus.vplan.app.core.database.model.embedded.EmbeddedHomework
import plus.vplan.app.core.database.model.embedded.EmbeddedHomeworkTask
...
interface HomeworkDao {
    ...
    suspend fun updateSubjectInstanceAndGroup(homeworkId: Int, subjectInstanceId: Uuid?, groupId: Uuid?)
