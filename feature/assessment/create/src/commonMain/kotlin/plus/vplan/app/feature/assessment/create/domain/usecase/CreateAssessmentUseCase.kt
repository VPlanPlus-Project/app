package plus.vplan.app.feature.assessment.create.domain.usecase
...
class CreateAssessmentUseCase(
    ...
    suspend operator fun invoke(
        ...
        val profile = (getCurrentProfileUseCase().first() as? Profile.StudentProfile) ?: return CreateAssessmentResult.Error.UnknownError("No current profile found or profile is not a student profile")
