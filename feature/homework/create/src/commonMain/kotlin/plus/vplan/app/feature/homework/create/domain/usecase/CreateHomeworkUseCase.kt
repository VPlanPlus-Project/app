package plus.vplan.app.feature.homework.create.domain.usecase
...
class CreateHomeworkUseCase(
    ...
    suspend operator fun invoke(
        ...
        val profile = (getCurrentProfileUseCase().first() as? Profile.StudentProfile) ?: return unknownError("No current profile found or profile is not a student profile")
        val id: Int
