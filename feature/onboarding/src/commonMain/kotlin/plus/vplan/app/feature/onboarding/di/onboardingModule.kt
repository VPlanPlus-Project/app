...
import plus.vplan.app.feature.onboarding.stage.permissions.ui.PermissionsViewModel
...
val onboardingModule = module {
    ...
    singleOf(::BuildProfileOptionsFromLocalDataUseCase)
    singleOf(::FetchAndStoreSchoolDataUseCase)
