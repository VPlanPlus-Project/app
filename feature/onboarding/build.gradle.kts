...
kotlin {
    ...
    android {
        namespace = "plus.vplan.app.feature.onboarding"
...
buildConfig {
    // Module-specific package: plus.vplan.app.feature.onboarding.AppBuildConfig
    packageName("plus.vplan.app.feature.onboarding")
    generateAtSync = true
}