    ...
    suspend operator fun invoke(profile: Profile) {
        ...
        homeworkRepository.getAll()
            ...
            .filter { homework ->
                ...
                (homework.creator is AppEntity.Profile && (homework.creator as AppEntity.Profile).profile.id == profile.id) ||
                        (homework.creator is AppEntity.VppId && (homework.creator as AppEntity.VppId).vppId.id == (profile as? Profile.StudentProfile)?.vppId?.id) ||
